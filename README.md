...
- Shows **Fajr, Sunrise, Dhuhr, Asr, Maghrib, Isha** for the current day.
...
const LOCATIONS = [
  ...
  { name: "Yemalur (Bengaluru)", lat: 12.9500, lon: 77.6608 },
  { name: "Ejipura (Bengaluru)", lat: 12.9351, lon: 77.6398 },
];
```
...
- **Tap the widget** to open a picker and switch locations — your choice is saved and used for future widget refreshes.
- iOS controls widget refresh timing (usually a few times a day); opening the widget/app manually forces an immediate refresh.
